...
export const DEFAULT_SCENARIO: Scenario = {
  ...
  grants: [{ id: "grant-a", name: "Initial grant", assetId: "acme", grantDate: "2027-01-01", shares: 2000n, vesting: { kind: "preset", durationMonths: 48, cadenceMonths: 3, cliffMonths: 12 } }, { id: "grant-b", name: "Refresh grant", assetId: "acme", grantDate: "2028-01-01", shares: 800n, vesting: { kind: "preset", durationMonths: 36, cadenceMonths: 12, cliffMonths: 0 } }],
  tax: { mode: "blended", blendedRate: 0.2, byComponent: { salary: 0.2, bonus: 0.2, signOn: 0.2, equity: 0.2 } },
  fxPairs: [{ base: "USD", quote: "SGD", rateAtAnchor: 1.35, anchorDate: "2027-01-01", annualDrift: 0.01 }], risk: { seed: 42, volatilities: { "equity:acme": 0.25, "fx:USD/SGD": 0.07 }, correlation: [[1, 0.2], [0.2, 1]] },
};
